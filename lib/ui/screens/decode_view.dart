...
// Pastikan import path ini sesuai
...
class _DecodeViewState extends State<DecodeView> {
  ...
  Future<void> _processDecoding() async {
    ...
    try {
      ...
      final Map<String, String> resultData = LSBEngine.decodeMessageWithIntegrity(imageBytes);

      if (resultData["status"] == "ERROR") {
        setState(() => _decodedMessage = "FAILED: No hidden data found or file compromised.");
        return;
      }

      final String cipherText = resultData["message"]!;
      final String originalText = AESCipher.decryptText(cipherText, _passController.text);

      if (originalText == "PASSWORD SALAH") {
         setState(() => _decodedMessage = "ACCESS DENIED: Invalid Decryption Key.");
      } else {
         setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColors.paper, // Background utama
      appBar: AppBar(
        backgroundColor: AppColors.paper,
        elevation: 0,
        iconTheme: const IconThemeData(color: AppColors.ink),
        title: const Text("DECRYPT ARCHIVE", 
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            // IMAGE AREA (Rounded & Folder Color)
            GestureDetector(
              onTap: _pickImage,
              child: Container(
                height: 220,
                ...
                decoration: BoxDecoration(
                  color: AppColors.folder, // Menggunakan warna folder
                ...
                child: ClipRRect(
                  ...
                  child: _selectedImage == null
                      ? Column(
                          ...
                          children: [
                            Icon(Icons.search, size: 60, color: AppColors.ink.withValues(alpha: 0.5)),
                            const SizedBox(height: 10),
                            Text("TAP TO ANALYZE EVIDENCE", 
                                style: TextStyle(fontFamily: 'Typewriter', color: AppColors.ink.withValues(alpha: 0.6))),
                          ],
                        )
                      : Stack(
                          fit: StackFit.expand,
                          children: [
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: const Text("EVIDENCE LOADED", 
                                  style: TextStyle(color: Colors.green, fontSize: 10, fontFamily: 'Courier')),
                              ),
                            )
                          ],
                        ),
            ...
            // INPUT KEY (Rounded & Folder Color)
            _buildSpyTextField(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: _isProcessing || _selectedImage == null ? null : _processDecoding,
                ...
                child: _isProcessing 
                  ...
                  : const Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 10),
                        Text("EXTRACT & VERIFY", style: TextStyle(fontFamily: 'Typewriter', fontWeight: FontWeight.bold, fontSize: 16)),
                      ],
                    ),
              ),
            ),
              ...
              child: Row(
                ...
                children: [
                  const Text("DECRYPTED INTEL:", 
                    style: TextStyle(fontFamily: 'Typewriter', fontWeight: FontWeight.bold)),
            ...
            if (_integrityStatus.isNotEmpty) 
              Align(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: _integrityStatus == "VERIFIED" ? Colors.green : Colors.red,
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(
                        _integrityStatus == "VERIFIED" ? Icons.verified : Icons.warning, 
            ...
            // RESULT BOX (Rounded & Folder Color)
            Container(
              width: double.infinity,
              padding: const EdgeInsets.all(20),
              decoration: BoxDecoration(
              ...
              child: Text(
                _decodedMessage.isEmpty ? "WAITING FOR DECRYPTION..." : _decodedMessage,
                style: TextStyle(
                  fontFamily: 'Typewriter', 
                  fontSize: 16, 
                  color: _decodedMessage.contains("EXPIRED") ? Colors.grey : AppColors.ink, 
                  height: 1.5
                ),
              ),
            ),
  ...
  Widget _buildSpyTextField({
    ...
    return Container(
      decoration: BoxDecoration(
        color: AppColors.folder, // Warna folder
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          filled: true,
          fillColor: AppColors.folder, // Warna folder
...
class _TerminalLoaderState extends State<TerminalLoader> {
  ...
  Widget build(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        const SizedBox(width: 15, height: 15, child: CircularProgressIndicator(color: AppColors.paper, strokeWidth: 2)),
        const SizedBox(width: 15),
        SizedBox(
          width: 200,
          child: Text("> $_currentLog", style: const TextStyle(fontFamily: 'Courier', color: AppColors.paper, fontWeight: FontWeight.bold, fontSize: 12), maxLines: 1, overflow: TextOverflow.ellipsis),
        ),
      ],
    );
  }
